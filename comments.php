...
<p><?php printf('<a href="%1$s">%2$s</a>', get_option('siteurl') . '/wp-admin/profile.php', $user_identity); ?> <small>(<a href="<?php echo wp_logout_url(get_permalink()); ?>" title="Desconectar">Desconectar</a>)</small></p>
